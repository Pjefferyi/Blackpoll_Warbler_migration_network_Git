...
# Initial Path #################################################################
path <- thresholdPath(twl$Twilight, twl$Rise, zenith = zeniths_med, tol=0.06)
...
fixedx[1:2] <- T # We only fix the furst two location estimates because the track is incomplete 

...
#get data for ML6740_V8757_055
ligdata <- readLig("C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/BLPW_geo_2020/breed/ML6740 V8757 055/ML6740 V8757 055 reconstructed_000.lig", skip = 0)
...
#ligdata$Date <- anytime(ligdata$Date, asUTC = TRUE, tz = "UTC")+ 5*60*60
ligdata$Date <- anytime(ligdata$Date)

#plot light levels for a few days
threshold <- 3 # slightly above night recordings
with(ligdata[0:1000,], plot(Date, Light, type = "o"))
...
savings.t <- as.POSIXct(c("2013-03-12", "2012-11-06"), tz = "UTC")
abline(v = savings.t, lwd = 2, lty = 2, col = "orange")
...
#save output 
#write.csv(twl,"C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/Twilight_times/Twilight_times_ML6740_V8757_055")
twlNW <- read.csv("C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/Twilight_times/Twilight_times_ML6740_V8757_055.csv")

# SGAT analysis ================================================================

twlNW$Twilight <- as.POSIXct(twlNW$Twilight, tz = "UTC")

lightImage( tagdata = ligdata,
            offset = offset,     
            zlim = c(0, 20))

tsimagePoints(twlNW$Twilight, offset = offset, pch = 16, cex = 1.2,
              col = ifelse(twlNW$Rise, "firebrick", "cornflowerblue"))
...
tsimageDeploymentLines(twlNW$Twilight, lon.calib, lat.calib, offset, lwd = 2, col = "orange")

tm.calib <- as.POSIXct(c("2012-07-14", "2012-09-01"), tz = "UTC")
abline(v = tm.calib, lwd = 2, lty = 2, col = "orange")

d_calib <- subset(twlNW, Twilight>=tm.calib[1] & Twilight<=tm.calib[2])
...
#initial path ===================================================================
path <- thresholdPath(twlA2015$Twilight, twlA2015$Rise, zenith = zenith, tol=0.01)
...
twl_export <- twGeos2TAGS(raw = ligdata[, c("Date", "Light")], twl = twl,
                          threshold = 3,
                          filename = "C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/TAGS_data/TAGS_ML6740_V8757_055")

twlV8757_055 <- get.tags.data("C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/TAGS_data/TAGS_ML6740_V8757_055.csv")
...
save(all.obs, file = "C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/Deluca2015_A_FlightRCalib.RData")
all.obs <- load("C:/Users/Jelan/OneDrive/Desktop/University/University of Guelph/Thesis/Blackpoll_data/Blackpoll_twl_data/Deluca2015_A_FlightRCalib.RData")

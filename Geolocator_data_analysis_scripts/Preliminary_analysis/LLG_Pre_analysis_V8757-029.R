...
# tag number: V8757-029
# site: British Columbia, near Highway 37
...
# time of deployment (must estimate from light data)
#deploy.start <- anytime("", tz = "GMT")
...
# import lig data 
lig <- readLig(paste0(dir, "/ML6740 V8757 029 reconstructed_000.lig"), skip = 1)
...
period <- as.POSIXct(c("2019-07-01", "2019-08-15"), tz = "UTC")
...
# plot light levels 
# open jpeg
jpeg(paste0(dir, "/V8757_029_light_plot.png"), width = 1024, height = 990)
...
twl <- read.csv(paste0(dir,"/Pre_analysis_V8757 029_twl_times.csv"))
...
tm.calib <- as.POSIXct(c(deploy.start, deploy.start + days(55)), tz = "UTC")
...
#save(sm, file = paste0(dir,"/Pre_analysis_V8757_029_SGAT_estelle_summary.csv"))
#save(fit, file = paste0(dir,"/Pre_analysis_V8757_029_SGAT_estelle_fit.R"))

#load the output of the estelle model 
#load(paste0(dir,"/Pre_analysis_V8757_029_SGAT_estelle_summary.csv"))
#load(paste0(dir,"/Pre_analysis_V8757_029_SGAT_estelle_fit.R"))

# Plot Results #################################################################

# open jpeg
jpeg(paste0(dir, "/V8757029_Estelle_path.png"), width = 1024 , height = 990)
...
lines(sm[,"Lon.50%"], sm[,"Lat.50%"], 
      col = ifelse(sm$Time1 > spring.equi - days(21) & sm$Time1 < spring.equi + days(15), adjustcolor("blue", alpha.f = 0.6), adjustcolor("firebrick", alpha.f = 0.6)),
      type = "o", pch = 16)
...
# open jpeg
jpeg(paste0(dir, "/V8757029_mean_lon_lat.png"), width = 1024 , height = 990)
...
# merge site helps to put sites together that are separated by single outliers.
mS <- mergeSites(twl = geo_twl, site = cL$site, degElevation = 90-zenith_ad, distThreshold = 800)
...
#save(sm, file = paste0(dir,"/Pre_analysis_8757_029_SGAT_GroupedThreshold_summary.csv"))

...
arr.nbr.sgat <- sm %>% filter(Lat.50. < 13.5 & sitenum > 0 & duration > stat.nbr.lim) %>% 
  first(.$StartTime) %>% .$StartTime
dep.nbr.sgat <- sm %>% filter(Lat.50. < 13.5 & sitenum > 0 & duration > stat.nbr.lim) %>%
...
dep.br <- "2016-09-13 0:51"
arr.br <- "2017-05-31 3:13"

...
#threshold path median positions
points(dtx0[sitenum > 0,], pch = 16, cex = 1, col = "green")
...
dep.br <- "2016-08-17 7:23"
arr.br <- NA # geolocator stopped recording before return
...
geo.ref[(geo.ref$geo.id == geo.id),]$nbr.departure <- as.Date(dep.br)

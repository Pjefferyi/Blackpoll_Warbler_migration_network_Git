...
sm <- sm %>% mutate(period= case_when(StartTime < anytime("2016-10-23 22:12:30", asUTC = T, tz = "GMT")  ~ "Post-breeding migration",
                                      StartTime >= anytime("2016-10-23 22:12:30", asUTC = T, tz = "GMT") ~ "Non-breeding period"))

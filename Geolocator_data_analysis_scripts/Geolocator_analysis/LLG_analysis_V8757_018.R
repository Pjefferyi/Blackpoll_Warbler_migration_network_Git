...
#calibration period and after before the migration 
tm.calib1 <- as.POSIXct(c("2019-07-15", "2019-08-30"), tz = "UTC")
tm.calib2 <- as.POSIXct(c("2020-06-01", "2020-06-15"), tz = "UTC")

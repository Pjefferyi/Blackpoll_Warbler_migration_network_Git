...
dep.br <- NA # can't estimate departure due to low variation in longitude and the equinox 
arr.br <- NA # can't estimate arrival date because the geolocator stopped befor the return

par(mfrow=c(2,1))
plot(twl$Twilight, type  = "l", x0_ad[,1])
abline(v = arr.nbr.sgat)

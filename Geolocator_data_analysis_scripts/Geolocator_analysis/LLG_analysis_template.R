...
cL <- changeLight(twl=geo_twl, quantile=0.92, summary = F, days = 2, plot = T)
...
# This seems long enough to suggest that the bird flew from the coast of North America all the way to South America without stopping in the carribean
# However, looking at the latitude data, it also seems possible that this bird stopped over in Cuba

...
deploy.start <- anytime("2020-03-07 6:40:00", tz = "GMT")

# time of recovery (estimated from light data)
deploy.end <- anytime("2021-02-23 9:00:00", tz = "GMT")
...
# import lig data 
lig <- readLig(paste0(dir, "/ML6740 V8757 059 reconstructed_000.lig"), skip = 1)
...
# open jpeg
jpeg(paste0(dir, "/WRMA04173_light_plot.png"), width = 1024, height = 990)
...
#write.csv(twl, paste0(dir,"/Pre_analysis_WRMA04173_twl_times.csv"))
...
twl <- read.csv(paste0(dir,"/Pre_analysis_WRMA04173_twl_times.csv"))
...
# open jpeg
jpeg(paste0(dir, "/WRMA04173_Threshold_path.png"), width = 1024, height = 990)
...
fixedx[1:2] <- T # first two location estimates, we do not fix the last location because only the spring migration was recorded
...
# open jpeg
jpeg(paste0(dir, "/WRMA04173_Estelle_path.png"), width = 1024 , height = 990)
...
# open jpeg
jpeg(paste0(dir, "/WRMA04173_mean_lon_lat.png"), width = 1024 , height = 990)
...
#save(sm, file = paste0(dir,"/Pre_analysis_WRMA_04173_SGAT_GroupedThreshold_summary.csv"))
#save(fit, file = paste0(dir,"/Pre_analysis_WRMA_04173_SGAT_GroupedThreshold_fit.R"))

...
#write.csv(twl_in, paste0(dir,"/Pre_analysis_V8757_010_twl_times_initial.csv"))
twl_in <- read.csv(paste0(dir,"/Pre_analysis_V8757_010_twl_times_initial.csv"))
...
period <- as.POSIXct(c("2019-06-22", "2019-08-12"), tz = "UTC")
...
# write.csv(twl, paste0(dir,"/Pre_analysis_V8757_010_twl_times.csv"))
...
twl <- read.csv(paste0(dir,"/Pre_analysis_V8757_010_twl_times.csv"))
...
# open jpeg
jpeg(paste0(dir, "/V8757010_Estelle_path.png"), width = 1024 , height = 990)
...
# open jpeg
jpeg(paste0(dir, "/V8757010_mean_lon_lat.png"), width = 1024 , height = 990)
...
cL <- changeLight(twl=geo_twl, quantile=0.6, summary = F, days = 3, plot = T)
...
#save(sm, file = paste0(dir,"/Pre_analysis_8757_010_SGAT_GroupedThreshold_summary.csv"))
#save(fit, file = paste0(dir,"/Pre_analysis_8757_010_SGAT_GroupedThreshold_fit.R"))

#Load data from previous model run 
#load(paste0(dir,"/Pre_analysis_8757_010_SGAT_GroupedThreshold_summary.csv")
#load(paste0(dir,"/Pre_analysis_8757_010_SGAT_GroupedThreshold_fit.R")

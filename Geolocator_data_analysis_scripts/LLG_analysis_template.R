...
#Additional tools that can be used with Geololight, SGAT, and FlightR
...
#ligdata <- rename(ligdata, Date = X, Light = X) %>%
#    mutate(Date = anytime(Date, asUTC = TRUE, tz = "UTC"))
  
# plot light levels for a few days
threshold <-  #Note, this threshold is also used for to annotate twilights woth preprocessLight 

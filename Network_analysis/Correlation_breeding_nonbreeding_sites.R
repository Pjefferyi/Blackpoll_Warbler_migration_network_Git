...
ggplot(data = geo.loc.data, aes(x = breed.lon, y = nbr1.lon)) + 
  geom_point() + 
...
ggplot(data = geo.loc.data, aes(x = breed.lon, y = nbr2.lon)) + 
  geom_point() + 
  geom_smooth(method = "lm") + 
  theme_bw() +
  labs(x = "Breeding longitude",
...
ggplot(data = geo.loc.data, aes(x = breed.lat, y = nbr1.lat)) + 
  geom_point() + 
  geom_smooth(method = "lm") + 
  theme_bw() +
...
# Plot the first nonbreeding latitude against the breeding latitude
ggplot(data = geo.loc.data, aes(x = breed.lat, y = nbr2.lat)) + 
  geom_point() + 
  geom_smooth(method = "lm") + 
  theme_bw() +
  labs(x = "Breeding latitude",
